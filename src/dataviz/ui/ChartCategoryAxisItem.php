...
of categories to denote the far end of the axis.
     ...
     * @return \yii2\kendo\dataviz\ui\ChartCategoryAxisItem
     */
...
Individual color settings for line and labels take priority.
     ...
     * @param \yii2\kendo\dataviz\ui\ChartCategoryAxisItemLabels|array $value
     * @return \yii2\kendo\dataviz\ui\ChartCategoryAxisItem
     */
     ...
     * @param \yii2\kendo\dataviz\ui\ChartCategoryAxisItemLine|array $value
     * @return \yii2\kendo\dataviz\ui\ChartCategoryAxisItem
     */
...
body of the chart.
     * @param \yii2\kendo\dataviz\ui\ChartCategoryAxisItemMajorGridLines|array $value
     * @return \yii2\kendo\dataviz\ui\ChartCategoryAxisItem
     */
     ...
     * @param \yii2\kendo\dataviz\ui\ChartCategoryAxisItemMajorTicks|array $value
     * @return \yii2\kendo\dataviz\ui\ChartCategoryAxisItem
     */
...
the body of the chart.Note that minor grid lines are not visible by default, therefore none of these settings will take effect with the minor grid lines visibility being set to true.
     * @param \yii2\kendo\dataviz\ui\ChartCategoryAxisItemMinorGridLines|array $value
     * @return \yii2\kendo\dataviz\ui\ChartCategoryAxisItem
     */
     ...
     * @param \yii2\kendo\dataviz\ui\ChartCategoryAxisItemMinorTicks|array $value
     * @return \yii2\kendo\dataviz\ui\ChartCategoryAxisItem
     */
...
The axis will be rendered in the first (default) pane if not set.
     ...
     * @param \yii2\kendo\dataviz\ui\ChartCategoryAxisItemPlotBand|array,... $value one or more ChartCategoryAxisItemPlotBand to add.
     * @return \yii2\kendo\dataviz\ui\ChartCategoryAxisItem
     */
...
categories are listed from right to left and from top to bottom.
     ...
     * @param \yii2\kendo\dataviz\ui\ChartCategoryAxisItemSelect|array $value
     * @return \yii2\kendo\dataviz\ui\ChartCategoryAxisItem
     */
     ...
     * @param \yii2\kendo\dataviz\ui\ChartCategoryAxisItemTitle|array $value
     * @return \yii2\kendo\dataviz\ui\ChartCategoryAxisItem
     */
...
either baseUnit is set to "fit" or baseUnitStep is set to "auto".This option is ignored in all other cases.
     ...
     * @param \yii2\kendo\dataviz\ui\ChartCategoryAxisItemCrosshair|array $value
     * @return \yii2\kendo\dataviz\ui\ChartCategoryAxisItem
     */
