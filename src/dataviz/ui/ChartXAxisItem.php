...
class ChartXAxisItem extends SerializableObject {

    /**
     * Color to apply to all axis elements.
Individual color settings for line and labels take priority. Any valid CSS color string will work here, including hex and rgb.
     * @param string $value
     * @return \yii2\kendo\dataviz\ui\ChartXAxisItem
     */
...
The default baseUnit is determined automatically from the value range. Available options:
     ...
     * @param \yii2\kendo\dataviz\ui\ChartXAxisItemLabels|array $value
     * @return \yii2\kendo\dataviz\ui\ChartXAxisItem
     */
...
It defaults to 1/5th of the majorUnit.
     ...
     * @param \yii2\kendo\dataviz\ui\ChartXAxisItemLine|array $value
     * @return \yii2\kendo\dataviz\ui\ChartXAxisItem
     */
...
body of the chart.
     * @param \yii2\kendo\dataviz\ui\ChartXAxisItemMajorGridLines|array $value
     * @return \yii2\kendo\dataviz\ui\ChartXAxisItem
     */
     ...
     * @param \yii2\kendo\dataviz\ui\ChartXAxisItemMajorTicks|array $value
     * @return \yii2\kendo\dataviz\ui\ChartXAxisItem
     */
...
The axis will be rendered in the first (default) pane if not set.
     ...
     * @param \yii2\kendo\dataviz\ui\ChartXAxisItemPlotBand|array,... $value one or more ChartXAxisItemPlotBand to add.
     * @return \yii2\kendo\dataviz\ui\ChartXAxisItem
     */
...
values increase from right to left and from top to bottom.
     ...
     * @param \yii2\kendo\dataviz\ui\ChartXAxisItemTitle|array $value
     * @return \yii2\kendo\dataviz\ui\ChartXAxisItem
     */
     ...
     * @param \yii2\kendo\dataviz\ui\ChartXAxisItemCrosshair|array $value
     * @return \yii2\kendo\dataviz\ui\ChartXAxisItem
     */
