...
Individual color settings for line and labels take priority. Any valid CSS color string will work here, including hex and rgb.
     * @param string $value
     * @return \yii2\kendo\dataviz\ui\StockChartXAxisItem
     */
...
The default baseUnit is determined automatically from the value range. Available options:
     ...
     * @param \yii2\kendo\dataviz\ui\StockChartXAxisItemLabels|array $value
     * @return \yii2\kendo\dataviz\ui\StockChartXAxisItem
     */
...
It defaults to 1/5th of the majorUnit.
     ...
     * @param \yii2\kendo\dataviz\ui\StockChartXAxisItemLine|array $value
     * @return \yii2\kendo\dataviz\ui\StockChartXAxisItem
     */
...
body of the chart.
     * @param \yii2\kendo\dataviz\ui\StockChartXAxisItemMajorGridLines|array $value
     * @return \yii2\kendo\dataviz\ui\StockChartXAxisItem
     */
     ...
     * @param \yii2\kendo\dataviz\ui\StockChartXAxisItemMajorTicks|array $value
     * @return \yii2\kendo\dataviz\ui\StockChartXAxisItem
     */
...
The axis will be rendered in the first (default) pane if not set.
     ...
     * @param \yii2\kendo\dataviz\ui\StockChartXAxisItemPlotBand|array,... $value one or more StockChartXAxisItemPlotBand to add.
     * @return \yii2\kendo\dataviz\ui\StockChartXAxisItem
     */
...
values increase from right to left and from top to bottom.
     ...
     * @param \yii2\kendo\dataviz\ui\StockChartXAxisItemTitle|array $value
     * @return \yii2\kendo\dataviz\ui\StockChartXAxisItem
     */
     ...
     * @param \yii2\kendo\dataviz\ui\StockChartXAxisItemCrosshair|array $value
     * @return \yii2\kendo\dataviz\ui\StockChartXAxisItem
     */
