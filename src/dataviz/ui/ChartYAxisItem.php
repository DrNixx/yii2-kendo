...
class ChartYAxisItem extends SerializableObject {
...
is of type Date. Specify type explicitly when such behavior is undesired.
     * @param string $value
     * @return \yii2\kendo\dataviz\ui\ChartYAxisItem
     */
...
Individual color settings for line and labels take priority. Any valid CSS color string will work here, including hex and rgb.
     ...
     * @param \yii2\kendo\dataviz\ui\ChartYAxisItemLabels|array $value
     * @return \yii2\kendo\dataviz\ui\ChartYAxisItem
     */
...
It defaults to 1/5th of the majorUnit.
     ...
     * @param \yii2\kendo\dataviz\ui\ChartYAxisItemLine|array $value
     * @return \yii2\kendo\dataviz\ui\ChartYAxisItem
     */
...
body of the chart.
     * @param \yii2\kendo\dataviz\ui\ChartYAxisItemMajorGridLines|array $value
     * @return \yii2\kendo\dataviz\ui\ChartYAxisItem
     */
     ...
     * @param \yii2\kendo\dataviz\ui\ChartYAxisItemMajorTicks|array $value
     * @return \yii2\kendo\dataviz\ui\ChartYAxisItem
     */
...
The axis will be rendered in the first (default) pane if not set.
     ...
     * @param \yii2\kendo\dataviz\ui\ChartYAxisItemPlotBand|array,... $value one or more ChartYAxisItemPlotBand to add.
     * @return \yii2\kendo\dataviz\ui\ChartYAxisItem
     */
...
values increase from right to left and from top to bottom.
     ...
     * @param \yii2\kendo\dataviz\ui\ChartYAxisItemTitle|array $value
     * @return \yii2\kendo\dataviz\ui\ChartYAxisItem
     */
     ...
     * @param \yii2\kendo\dataviz\ui\ChartYAxisItemCrosshair|array $value
     * @return \yii2\kendo\dataviz\ui\ChartYAxisItem
     */
