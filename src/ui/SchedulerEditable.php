...
class SchedulerEditable extends SerializableObject
{
    /**
    ...
    /**
     * If set to true the scheduler allows event resizing.
     * Dragging the resize handles changes the start or end time of the event.
     *
     * @param boolean $value
     *
     * @return SchedulerEditable
     ...
     * The configuration is optional.For more information, please refer to the Window configuration API.
     *
     * @param  $value
     *
     * @return SchedulerEditable
