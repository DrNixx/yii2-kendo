...
class SchedulerPdf extends SerializableObject
{
    use DateChecker;
     ...
     * Supported units are "mm", "cm", "in" and "pt" (default).
     *
     * @param SchedulerPdfMargin|array $value
     *
     * @return SchedulerPdf
     */
     ...
     * Supported values: A predefined size: "A4", "A3" etc;
     * An array of two numbers specifying the width and height in points (1pt = 1/72in) or
    ...
    /**
     * The URL of the server side proxy which will stream the file to the end user.A proxy will be used when
     * the browser isn't capable of saving files locally. Such browsers are IE version 9 and lower and Safari.
     * The developer is responsible for implementing the server-side proxy.
     * The proxy will receive a POST request with the following parameters in the request body:
     * contentType: The MIME type of the file;
     * base64: The base-64 encoded file content or
     ...
     * If you want to display the document in a new window or iframe, the proxy should set
     * the "Content-Disposition" header to inline; filename="<fileName.pdf>".
     *
     * @param string $value
     *
     * @return SchedulerPdf
