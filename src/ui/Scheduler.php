...
class Scheduler extends Widget
{
     ...
     * title String - the event title.
     *
     * @param string|JavaScriptFunction $value The template content.
     *
     * @return Scheduler
     */
     ...
     * That will also apply for data sources for the resources used in the widget.
     ...
     * @param boolean|SchedulerCurrentTimeMarker|array $value
     * @return Scheduler
     */
     ...
     * The "ddd" specifier represents the abbreviated name of the week day and will be localized
     * using the current Kendo UI culture.
     ...
     *
     * @param boolean|SchedulerEditable|array $value
     *
     * @return Scheduler
     */
     ...
     *
     * @param boolean|SchedulerFooter|array $value
     *
     * @return Scheduler
     */
     ...
     *
     * @param SchedulerGroup|array $value
     *
     * @return Scheduler
     */
     ...
     * @param SchedulerMessages|array $value
     * @return Scheduler
     */
     ...
     * @param SchedulerPdf|array $value
     * @return Scheduler
     */
     ...
     * @param SchedulerResource|array,... $value one or more SchedulerResource to add.
     * @return Scheduler
     */
     ...
     * @param SchedulerToolbarItem|array,... $value one or more SchedulerToolbarItem to add.
     * @return Scheduler
     */
     ...
     * @param SchedulerView|array,... $value one or more SchedulerView to add.
     * @return Scheduler
     */
