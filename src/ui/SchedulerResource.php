...
class SchedulerResource extends SerializableObject
{
    /**
    ...
    */
    ...
    /**
    * The field of the resource data item which represents the resource value.
     * The resource value is used to link a scheduler event with a resource.
     *
    * @param string $value
     *
    * @return SchedulerResource
    ...
    */
    ...
    /**
    * If set to true the scheduler event can be assigned multiple instances of the resource.
     * The scheduler event field specified via the field option will contain an array of resources.
    ...
    */
    ...
    /**
    * The name of the resource used to distinguish resource.
     * If not set the value of the field option is used.
     *
    * @param string $value
     *
    * @return SchedulerResource
    */
    ...
    /**
    * The user friendly title of the resource displayed in the scheduler edit form.
     * If not set the value of the field option is used.
     *
    * @param string $value
     *
    ...
    * Set to false if the scheduler event field specified via the field option contains a resource data item.
     * By default the scheduler expects that field to contain a primitive value (string, number)
     * which corresponds to the "value" of the resource (specified via dataValueField).
     *
    * @param boolean $value
     *
    * @return SchedulerResource
