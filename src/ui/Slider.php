...
class Slider extends InputWidget
{
    ...
    /**
     * The delta with which the value will change when the user presses the Page Up or Page Down
     * key (the drag handle must be focused). Note: The allied largeStep will also set large tick for every large step.
     *
     * @param float $value
     *
     * @return Slider
     ...
     * Fires when the slider value changes as a result of selecting a new value with the
     * drag handle, buttons or keyboard.
     *
